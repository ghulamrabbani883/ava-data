...
import { hireDeveloperRight } from "./ServiceAndTechnologyData";
...
const Hire = () => {
  ...
  return (
    <main className="services">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Ava-Data/hire-developers</title>
        <link rel="canonical" href="http://localhost:3000/hire-developers" />
      </Helmet>
      <div className="serviceLeft">
        ...
        <div className="technologyBottom" style={{ "margin-top": "30px" }}>
          ...
          <p>
            Create your own agile squad with experienced members just like your
            local team
          </p>
        </div>
      </div>
      <div className="serviceRight">
        {hireDeveloperRight.map((rightData) => {
          return (
